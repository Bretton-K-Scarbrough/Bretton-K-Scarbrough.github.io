...
<section id="hero">
	<h1 class="hello">B.K. Scarbrough's Personal Blog</h1>
	<p class="intro">
		<!-- <span class="left">Rants about:</span> -->
		<!-- <span class="right">math, science, and engieering.</span> -->
		<!-- <span class="left">It supports Markdown,</span> -->
		<!-- <span class="right">and is really fast.</span> -->
	</p>
	<h3>
	Rants about math, science and engineering.
	<br />
	<br />
	</h3>
</section>
